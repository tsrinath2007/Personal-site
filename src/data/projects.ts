...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "A flight-path gamified focus engine where study sessions are visual flights. Syncs countdown timers with domestic aviation durations (e.g. Mumbai to Delhi = 2 hours) with interactive flight paths, elevation charts, and ambient audio loops — designed like optimization algorithms plotting train frequencies along the Purple Line.",
  ...
  },
  {
    ...
    description: "A simulated sandbox environment mimicking life-support loop parameters. Combines a PPO model with a Qwen2.5 model fine-tuned on historic NASA Apollo and ISS logs to optimize oxygen loops and water scrubbers — essential for emergency simulation when compartment cabin parameters face blockages.",
