          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-text-muted font-light leading-relaxed">
                Currently exploring optimization of agentic tool calling in low-resource models, custom CUDA kernel design for transformer blocks, and high-frequency edge sensor ingestion logic.
              </p>
            </div>
          </div>
