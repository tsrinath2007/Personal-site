    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 grid-bg border-b border-border-gold">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-8">
        ...
        <motion.p
          ...
          className="text-xs sm:text-sm text-text-muted/80 max-w-xl mx-auto font-light leading-relaxed"
        >
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-6 pt-4 text-text-muted"
        >
          <a
