...
export const COLLECTIONS: Collection[] = [
  {
    slug: "slow-mornings",
    name: "Slow Mornings",
    description: "Designed for peaceful rituals, morning light, and your first quiet cup.",
  ...
  },
  {
    slug: "dinner-at-home",
    name: "Dinner at Home",
    description: "Elevate your evening dining with earthy tones and tactile finishes.",
  ...
  },
  {
    slug: "table-stories",
    name: "Table Stories",
    description: "Ceramics meant to be passed around, sharing food and conversation.",
    image: "https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?q=80&w=800&auto=format&fit=crop",
    moodEmoji: "🌿",
  },
  {
    slug: "objects-for-home",
    name: "Objects for Home",
    description: "Sculptural, functional shapes that capture shadows and elevate rooms.",
...
export const PRODUCTS: Product[] = [
  {
    ...
    hoverImage: "https://images.unsplash.com/photo-1576092768241-dec231879fc3?q=80&w=600&auto=format&fit=crop",
    images: [
    ...
    details: "Individually thrown on the wheel, this mug features a subtle thumb rest and a raw clay base, perfect for wrapping your hands around on chilly mornings.",
    materials: "High-fire stoneware with a speckled iron glaze.",
    dimensions: "9cm height x 8cm diameter, holds 320ml.",
    care: "Dishwasher and microwave safe. Handwash recommended for longevity.",
    storyTitle: "MEET AARU",
    storyDesc: "Inspired by the quiet mist of early mornings in the Nilgiris, the Aaru mug is crafted by hands that have shaped clay for decades. Each mug features unique iron spots that bloom in the kiln, making it entirely yours.",
    storyImage: "https://images.unsplash.com/photo-1565192647048-f997ded87958?q=80&w=800&auto=format&fit=crop",
    options: [
      { name: "Color", values: ["Speckled Oat", "Slate Clay", "Dusk White"] },
    ...
    variants: [
      ...
      { id: "var_1e", name: "Dusk White / Standard", priceModifier: 0, stock: 20 },
      { id: "var_1f", name: "Dusk White / Tall", priceModifier: 150, stock: 0 }
    ],
    reviews: [
      ...
      { id: "rev_1c", author: "Rhea D.", rating: 4, date: "April 15, 2026", comment: "Slight variations in color make it feel very authentic. Beautiful craftsmanship.", verified: true }
    ],
  ...
  },
  {
    ...
    description: "Shallow raised rim for modern dinners.",
    details: "A flat salad plate with a raised rim, glazed in soft oatmeal with raw clay outer rims, highlighting the natural texture of high-fire clay.",
    materials: "High-fire stoneware, food-safe satin glaze.",
    dimensions: "21cm diameter.",
    care: "Dishwasher and microwave safe.",
    storyTitle: "SOIL TO TABLE",
    storyDesc: "Thrown flat and trimmed to perfection, the Aaru plate features a shallow lip that frames your food like art. Perfect for shared lunches and quiet, candle-lit dinners.",
  ...
  },
  {
    ...
    description: "Slow-steeping clay teapot.",
    details: "A modern, slow-steeping teapot featuring a hand-carved teak wood handle. Glazed tin-white on the inside for clean steeping, raw clay outside.",
    materials: "High-fire terracotta body with a tin-white interior glaze and teak wood handle.",
    dimensions: "14cm height, holds 650ml.",
    care: "Hand wash only. Avoid direct heat/stovetops.",
    storyTitle: "THE TEA RITUAL",
    storyDesc: "Designed to elevate your brewing experience. The clay body retains heat beautifully while the wood handle remains cool to the touch. Fired twice for durability.",
  ...
  },
  {
    ...
    hoverImage: "https://images.unsplash.com/photo-1612195973809-f1a5bb0f4886?q=80&w=600&auto=format&fit=crop",
    images: [
    ...
    description: "Deep bowl for comforting meals.",
    details: "Deep, comfortable-to-hold ceramic bowl for comforting meals like ramen, curries, or morning oatmeal.",
    ...
    care: "Dishwasher and microwave safe.",
    storyTitle: "COMFORT IN HANDS",
    storyDesc: "Crafted for hot ramen, summer salads, or morning oatmeal. The textured sand exterior provides a tactile connection to the earth, contrasting with the glossy, easy-to-clean interior.",
  ...
  },
  {
    ...
    description: "Sculptural narrow-neck bud vase.",
    details: "A sculptural vase with a narrow neck, perfect for a single wildflower, dry stem, or as an independent visual art piece.",
    materials: "Red clay with a textured terracotta wash and a clear glaze inside.",
    dimensions: "18cm height x 10cm width.",
    care: "Handwash only. Leakproof.",
    storyTitle: "SCULPTURAL SPACE",
    storyDesc: "An accent piece designed to capture light and shadow. Beautiful on its own or holding a single dry stem on a sun-drenched windowsill.",
    storyImage: "https://images.unsplash.com/photo-1532187863486-abf9d39d66e8?q=80&w=800&auto=format&fit=crop",
    options: [
  ...
  },
  {
    ...
    collection: "slow-mornings",
    image: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop",
    hoverImage: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=600&auto=format&fit=crop",
    images: [
      "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=600&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?q=80&w=600&auto=format&fit=crop",
    ],
    description: "Slow morning dripper.",
    details: "A single-cup coffee dripper that sits beautifully on top of any mug. Designed with a wide rim and spiraling ribs.",
    materials: "High-fire stoneware with iron speckling and a satin off-white finish.",
    dimensions: "11cm diameter x 8.5cm height.",
    care: "Dishwasher safe.",
    storyTitle: "SLOW BREWING",
    storyDesc: "Hand-carved internal ribs direct the flow of water for optimal coffee extraction. Enjoy the slow rhythm of manual brewing every morning.",
